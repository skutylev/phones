...
from phones.views import ListPhones, DetailPhone, UpdatePhone, ListUnits, call, autocomplete, autocomplete_unit, Main, Forbidden

# from phones.views import UnitSearchView

urlpatterns = patterns('',
    url(r'^$', Main.as_view(), name='main'),
    url(r'^forbidden/$', Forbidden.as_view(), name='forbidden'),
